                        ...
                        <div class="modal-body">
                            <div class="box-body" id="parent-form-area">
                                ...
                                <div class="form-group header-group-0 col-sm-12" id="form-group-identificacion" style="">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" title="Nombre" required=""  placeholder="Ingrese el nombre de la categoria"  sminlength="" class="form-control" name="nombre" id="nombre" value="{{$row->nombre}}" >
                                        <h6>Ej. Snack</h6>
